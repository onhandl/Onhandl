...
export const scopeError = (scope?: string) =>
    new AppError(
        403,
...
export const invalidApiKeyError = (message = 'Invalid or revoked API key') =>
    new AppError(401, message, ErrorCodes.INVALID_API_KEY);

export const rateLimitError = (message = 'Rate limit exceeded. Please slow down your requests.') =>
...
export const sendError = (reply: any, err: any) => {
