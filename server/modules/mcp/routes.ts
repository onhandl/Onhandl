...
export const mcpRoutes: FastifyPluginAsync = async (fastify) => {
    ...
    // Single POST endpoint per MCP spec (Streamable HTTP, 2025-03-26)
            ...
            if (method === 'initialize') {
                return {
                    ...
                    result: {
                        ...
                        serverInfo: { name: agent.name, version: '1.0.0' },
                        capabilities: { tools: {} },
                    },
                };
            }
...
/** Pipe the Orchestrator SSE stream into a plain text string. */
