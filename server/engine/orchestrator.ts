...
import { getCapacities, formatCKB } from '../packages/tooling/blockchain/src/ckb/balance';
import {
    parseWalletIntent,
    handleWalletIntent,
    WalletContext
...
export class Orchestrator {
    ...
    static async handleQuery(
        ...
        const hasCryptoTool = nodes.some(n =>
            n.type === 'crypto_wallet' || n.type === 'blockchain_tool' || n.type === 'crypto_trade'
        );
        const hasSocialTool = nodes.some(n => n.type === 'telegram' || n.type === 'whatsapp');
